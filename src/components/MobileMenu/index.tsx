    ...
    <>
      ...
      >
        ...
        <div className="relative flex w-12 h-12 mr-1 image-fit">
          ...
          <h2 className="ml-3 text-xl font-medium text-black">{`Hola${user? ', ' + user.nombre + ' ' + user.apellido : ''}`}</h2>
        </div>
        ...
        >
          ...
          <Link
            to="/"
            className="flex justify-start mt-[25px] pl-[25px]"
          >
            <img
...
function Menu(props: {
  ...
  return (
    ...
    >
      {/* <div>
        <Lucide className="text-black" icon={props.menu.icon} />
      </div> */}
